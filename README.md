...
2. Extract the downloaded `fayra-icon-theme-main.zip` archive.
3. Open the extracted `fayra-icon-theme-main` folder.
4. Inside it, you will find another folder named `fayra-icon-theme-main`. **Rename this inner folder to `Fayra`.**
5. Copy the renamed `Fayra` folder to one of the following locations:
...
The user-space installation is recommended for personal use.
